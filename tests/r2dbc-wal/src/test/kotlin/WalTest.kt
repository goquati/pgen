...
import de.quati.pgen.tests.r2dbc.wal.URL
import de.quati.pgen.tests.r2dbc.wal.createDb
import de.quati.pgen.tests.r2dbc.wal.generated.db.base.public.BaseSchemaPublic
import de.quati.pgen.tests.r2dbc.wal.generated.db.base.public.CitextTestTable
import de.quati.pgen.tests.r2dbc.wal.generated.db.base.public.DateTimeTestTable
import de.quati.pgen.tests.r2dbc.wal.generated.db.base.public.DomainTestTable
import de.quati.pgen.tests.r2dbc.wal.generated.db.base.public.EnumArrayTestTable
import de.quati.pgen.tests.r2dbc.wal.generated.db.base.public.EnumTestTable
import de.quati.pgen.tests.r2dbc.wal.generated.db.base.public.OrderId
import de.quati.pgen.tests.r2dbc.wal.generated.db.base.public.OrderStatus
import de.quati.pgen.tests.r2dbc.wal.shared.UserId
...
class WalTest {
    ...
    private suspend fun R2dbcDatabase.cleanup() = suspendTransaction {
    ...
    private suspend fun R2dbcDatabase.sendStopMessage(msg: String) = suspendTransaction {
        emitLogicalPgMessage(transactional = true, prefix = "foobar", message = msg, flush = true)
    }

    private suspend fun R2dbcDatabase.exampleChanges() = suspendTransaction {
    ...
    @Test
    fun `test WAL event streaming with r2dbc`(): Unit = blockingWithTimeout(timeout = 60.seconds) {
        val db = createDb()
        db.cleanup()
