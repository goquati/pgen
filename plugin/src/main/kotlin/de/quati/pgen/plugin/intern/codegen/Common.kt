...
import de.quati.pgen.plugin.intern.codegen.oas.addEnumMapper
import de.quati.pgen.plugin.intern.codegen.oas.addTableMapper
import de.quati.pgen.plugin.intern.codegen.oas.addTableService
...
internal object Poet {
    ...
    private val SchemaName.utilObjectName
        get() = c.dbSpec.name.name.toCamelCase(capitalized = true) + "Schema" + name.toCamelCase(capitalized = true)
