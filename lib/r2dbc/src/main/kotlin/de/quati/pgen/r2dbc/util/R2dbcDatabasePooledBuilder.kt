...
public class R2dbcDatabasePooledBuilder {
    ...
    private var transactionManager: ((R2dbcDatabase) -> R2dbcTransactionManager)? = null
    ...
    public fun transactionManager(block: (R2dbcDatabase) -> R2dbcTransactionManager): R2dbcDatabasePooledBuilder =
    ...
    public fun build(): R2dbcDatabase {
        ...
        return transactionManager?.let { manager ->
